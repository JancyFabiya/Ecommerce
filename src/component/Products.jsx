...
const Products = () => {
  ...
  return (
    <>
      <div className="col-span-3 mt-14 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0  grid  items-center justify-end  ">
                  ...
                  <div className="mb-1 ml-14 h-6">
                    <span class=" pl-0.5   bg-black "></span>
                  </div>
                  {trending ? (
                ...
                <div className="px-4 py-3 ">
                  ...
                  <div className="flex flex-row justify-between">
                    ...
                    <input
                      type="number"
                      id="visitors"
                      class=" w-14 h-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 flex flex-row"
                      placeholder="Qt"
                      required
                    />
